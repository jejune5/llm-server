...
class LLM:
    def __init__(self, model_dir="Qwen/Qwen-1_8B-Chat"):
        """
        参考...
        Args:
            model_dir:
    ...
    def chat(self, query, history=None, **kwargs):
        response, history = self.model.chat(self.tokenizer, query, history=history, **kwargs)
        return response, history


if __name__ == '__main__':
    model_dir = r'/Users/wu/data/model/llm/Qwen-1_8B-Chat-Int4'
    llm = LLM(model_dir)
    res = llm.chat('你是谁')
    print(res)
